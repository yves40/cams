              ...
              <v-form>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-4">
                    <ValidationProvider vid="password" name="password" rules="required|min:6|confirmed:passconf">
                      <v-text-field
                ...
                <div class="row">
                  <div class="col-4"></div>
                  <div class="form-group col-4">
                    <ValidationProvider vid="passconf" name="passwordctl" rules="required|min:6|confirmed:password">
                      <v-text-field
                        slot-scope="{ errors, valid }"
                        v-model="passwordctl"
                        :error-messages="errors"
